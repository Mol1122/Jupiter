...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "zAmfh2xGMGHb45pdwnFGvfrKTOmiwwkj";
	...
	private String getImageUrl(JSONObject events) throws JSONException {
		if (!events.isNull("images")) {
			JSONArray array = events.getJSONArray("images");
	...
	private Set<String> getCategories(JSONObject events) throws JSONException {
		...
		if (!events.isNull("classifications")) {
	...
	public static void main(String[] args) {
		...
		tmAPI.queryAPI(40.8859, -74.0435);
	}
}
