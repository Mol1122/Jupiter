...
(function() {
  ...
  function init() {
    ...
    loadNearbyItems();
    validateSession();
    //onSessionValid({"user_id":"1111","name":"Bear Yang","status":"OK"});
  }
  ...
  function onSessionValid(result) {
	    ...
	    var itemNav = document.querySelector('#btn-container');
	    var itemList = document.querySelector('#item-container');
  ...
  function loadNearbyItems() {
    ...
    var url = "./search";
    var params = "user_id=" + user_id + "&lat=" + lat + "&lon=" + long;
    var data = null;
  ...
  function loadRecommendedItems() {
	    ...
	    // request parameters
	    var url = './recommendation' + '?' + 'user_id=' + user_id + '&lat=' + lat + '&lon=' + long;
	    var data = null;
  ...
  function addItem(itemList, item) {
    ...
    // section
    var section = $create("div", {className: "item-info"});

    // category
    var category = $create("p", {
      className: "item-category"
    });
    category.innerHTML = item.categories;
    ...
    // ',' => '<br/>',  '\"' => ''
    address.innerHTML = item.address.replace(/,/g, ' | ').replace(/\"/g, '');
    section.appendChild(address);
    
    li.appendChild(section);

    //favorite link
    var favLink = $create("div", { className: "fav-link" });
